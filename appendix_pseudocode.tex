...
\textbf{Source:} project pseudocode handout \cite{numerical-analysis-fco-2}.
...
\textbf{Source:} project pseudocode handout \cite{numerical-analysis-fco-2}; supporting LU notes \cite{lu-notes}.
...
\textbf{Source:} project pseudocode handout \cite{numerical-analysis-fco-2}; stopping-rule presentation aligned with Chapra and Canale \cite{chapra-canale-2010}.
...
\textbf{Source:} project pseudocode handout \cite{numerical-analysis-fco-2}; original hybrid GMRES reference \cite{nachtigal-gmres-1992}.
